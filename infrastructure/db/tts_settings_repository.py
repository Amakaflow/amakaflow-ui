"""
Supabase implementation of TTS Settings Repository.
...
class SupabaseTTSSettingsRepository:
    """Supabase-backed TTS settings repository."""

    TABLE = "user_voice_settings"

    def __init__(self, client: Client, daily_char_limit: int = 50_000) -> None:
        self._client = client
    ...
    def reset_daily_chars_if_needed(self, user_id: str) -> None:
        ...
        """
        self._ensure_record_exists(user_id)
        self._reset_daily_chars_if_needed(user_id)

    def _ensure_record_exists(self, user_id: str) -> None:
    ...
    def _reset_daily_chars_if_needed(self, user_id: str) -> None:
