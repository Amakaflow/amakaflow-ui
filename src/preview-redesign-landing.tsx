/**
 * Standalone preview entry point for the redesigned Landing surface.
 * Served at /redesign-landing-preview.html during dev.
 *
 ...
 * with the redesigned Landing component driven by seed data only.
 *
 * Description: Waitlist / public marketing page
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — Landing
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          Waitlist / public marketing page
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Landing UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
