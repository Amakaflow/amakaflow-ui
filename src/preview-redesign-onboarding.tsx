/**
 * Standalone preview entry point for the redesigned Onboarding surface.
 * Served at /redesign-onboarding-preview.html during dev.
 *
 ...
 * with the redesigned Onboarding component driven by seed data only.
 *
 * Description: 5-question coaching profile setup
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — Onboarding
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          5-question coaching profile setup
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Onboarding UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
