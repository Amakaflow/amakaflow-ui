/**
 * Standalone preview entry point for the redesigned Settings surface.
 * Served at /redesign-settings-preview.html during dev.
 *
 ...
 * with the redesigned Settings component driven by seed data only.
 *
 * Description: Pair status, subscription, logout
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — Settings
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          Pair status, subscription, logout
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Settings UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
