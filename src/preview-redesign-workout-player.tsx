/**
 * Standalone preview entry point for the redesigned Workout Player surface.
 * Served at /redesign-workout-player-preview.html during dev.
 *
 ...
 * with the redesigned Workout Player component driven by seed data only.
 *
 * Description: Live execution — timer, next step, swap
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — Workout Player
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          Live execution — timer, next step, swap
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Workout Player UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
