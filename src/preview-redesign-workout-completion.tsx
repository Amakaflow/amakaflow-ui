/**
 * Standalone preview entry point for the redesigned Workout Completion surface.
 * Served at /redesign-workout-completion-preview.html during dev.
 *
 ...
 * with the redesigned Workout Completion component driven by seed data only.
 *
 * Description: Post-workout RPE capture (1-5 + injury)
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — Workout Completion
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          Post-workout RPE capture (1-5 + injury)
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Workout Completion UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
