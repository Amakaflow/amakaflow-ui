/**
 * Standalone preview entry point for the redesigned History surface.
 * Served at /redesign-history-preview.html during dev.
 *
 ...
 * with the redesigned History component driven by seed data only.
 *
 * Description: Check-in history (recent 1-5 ratings + injuries)
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — History
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          Check-in history (recent 1-5 ratings + injuries)
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          History UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
