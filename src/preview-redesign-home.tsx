/**
 * Standalone preview entry point for the redesigned Home surface.
 * Served at /redesign-home-preview.html during dev.
 *
 ...
 * with the redesigned Home component driven by seed data only.
 *
 * Description: Today's workout + readiness chip + Start CTA
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '1.5rem', margin: '0 0 0.5rem' }}>
          Redesign placeholder — Home
        </h1>
        <p style={{ color: '#a0a0a0', margin: '0 0 1.5rem' }}>
          Today's workout + readiness chip + Start CTA
        </p>
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Home UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
