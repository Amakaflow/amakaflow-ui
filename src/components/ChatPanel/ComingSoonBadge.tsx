...
export function ComingSoonBadge() {
  return (
    <div className="fixed bottom-6 left-6 z-50">
      {/* Badge */}
      <div className="absolute -top-2 -left-2 z-10 flex items-center gap-1 rounded-full bg-gradient-to-r from-violet-500 to-purple-500 px-2 py-0.5 text-[10px] font-medium text-white shadow-lg">
