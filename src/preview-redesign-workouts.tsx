/**
 * Standalone preview entry point for the redesigned Workouts surface.
 * Served at /redesign-workouts-preview.html during dev.
 *
 ...
 * with the redesigned Workouts component driven by seed data only.
 *
 * Description: This-week plan list
 */
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '0.875rem', color: '#707070' }}>
          ...
          Workouts UI, driven by seed data only (no backend wiring).
        </p>
      </div>
    </div>
  );
